...
CONFIG(debug, debug|release) {
    ...
    macx {
        ...
        LIBS += -L$$OUT_PWD/../../libs/mac/build-quazip-0.7.3-qt-5.9.1-clang-9.0.0-x86_64 -lquazip_debug
    ...
    linux {
        # quazip
        LIBS += -L$$OUT_PWD/../../libs/centos/build-quazip-0.7.3-qt-5.9.1-centos-gcc-4.8.5-x86_64/quazip -lquazip_debug
    ...
    macx {
        # quazip
        LIBS += -L$$OUT_PWD/../../libs/mac/build-quazip-0.7.3-qt-5.9.1-clang-9.0.0-x86_64 -lquazip
    ...
    linux {
        # quazip
        LIBS += -L$$OUT_PWD/../../libs/centos/build-quazip-0.7.3-qt-5.9.1-centos-gcc-4.8.5-x86_64/quazip -lquazip
