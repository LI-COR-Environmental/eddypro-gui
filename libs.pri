...
CONFIG(debug, debug|release) {
    ...
    macx {
        ...
        LIBS += -L$$OUT_PWD/../../libs/mac/build-quazip-0.7.6-qt-5.11.3-clang-10.0.0-x86_64 -lquazip_debug
    ...
    macx {
        # quazip
        LIBS += -L$$OUT_PWD/../../libs/mac/build-quazip-0.7.6-qt-5.11.3-clang-10.0.0-x86_64 -lquazip
