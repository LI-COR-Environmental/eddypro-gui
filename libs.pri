...
CONFIG(debug, debug|release) {
    ...
    macx {
        ...
        LIBS += -L$$OUT_PWD/../libs/build-quazip-0.7.1-qt-5.6.0-clang-7.0.3-x86_64 -lquazip_debug
...
#        QMAKE_POST_LINK += $$_PRO_FILE_PWD_/scripts/build/mac-post-link.sh debug
    ...
    macx {
        # quazip
        LIBS += -L$$OUT_PWD/../libs/build-quazip-0.7.1-qt-5.6.0-clang-7.0.3-x86_64 -lquazip
