...
CONFIG(debug, debug|release) {
    ...
    macx {
        ...
        LIBS += -L$$OUT_PWD/../../libs/mac/build-quazip-0.7.3-qt-5.8.0-clang-8.1.0-x86_64 -lquazip_debug
    ...
    macx {
        # quazip
        LIBS += -L$$OUT_PWD/../../libs/mac/build-quazip-0.7.3-qt-5.8.0-clang-8.1.0-x86_64 -lquazip
