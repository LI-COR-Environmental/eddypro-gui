...
CONFIG(debug, debug|release) {
    ...
    macx {
        ...
        LIBS += -L$$OUT_PWD/../libs/build-quazip-0.7.1-qt-5.7.0-beta-clang-7.0.3-x86_64 -lquazip_debug
    ...
    linux {
        # quazip
        LIBS += -L$$OUT_PWD/../libs/build-quazip-0.7.1-qt-5.5.1-gcc-5.2.0-x86_64/quazip -lquazip_debug
...
#        QMAKE_POST_LINK += $$_PRO_FILE_PWD_/scripts/build/mac-post-link.sh debug
    ...
    macx {
        # quazip
        LIBS += -L$$OUT_PWD/../libs/build-quazip-0.7.1-qt-5.7.0-beta-clang-7.0.3-x86_64 -lquazip
