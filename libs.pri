...
CONFIG(debug, debug|release) {
    ...
    macx {
        ...
        LIBS += -L$$OUT_PWD/../libs/build-quazip-0.7.1-qt-5.4.2-clang-6.1.0-x86_64 -lquazip_debug
    ...
    macx {
        # quazip
        LIBS += -L$$OUT_PWD/../libs/build-quazip-0.7.1-qt-5.4.2-clang-6.1.0-x86_64 -lquazip
