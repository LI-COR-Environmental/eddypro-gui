      ...
      configState_(config)
{
    ...
    fileEdit->installEventFilter(const_cast<PlanarFitSettingsDialog*>(this));
...
bool PlanarFitSettingsDialog::eventFilter(QObject* watched, QEvent* event)
{
