...
const auto AdvancedSettingsPage::PAGE_TITLE_0 = QObject::tr("Processing Options");
const auto AdvancedSettingsPage::PAGE_TITLE_1 = QObject::tr("Statistical Analysis");
const auto AdvancedSettingsPage::PAGE_TITLE_2 = QObject::tr("Output Files");
const auto AdvancedSettingsPage::PAGE_TITLE_3 = QObject::tr("Computation Options");
const auto AdvancedSettingsPage::PAGE_TITLE_4 = QObject::tr("Spectral Analysis and Corrections");
