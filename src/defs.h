...
namespace Defs
{
    ...
    const auto APP_STAGE_STR = QStringLiteral("-rc3"); // -rc6
    ...
    const auto MAC_COMPILER = QStringLiteral("Apple LLVM 8.1.0 (clang-802.0.42) x86_64 on Mac OS X<sup>&reg;</sup> 10.12.4");
