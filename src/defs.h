...
namespace Defs
{
    ...
    const auto APP_STAGE_STR = QStringLiteral("-beta2"); // -rc1
    ...
    const auto MAC_COMPILER = QStringLiteral("Apple LLVM 10.0.0 (clang-1000.10.44.2) x86_64 on macOS<sup>&reg;</sup> 10.13.6");
