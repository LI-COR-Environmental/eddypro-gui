    ...
    QTableView(parent)
{
    ...
    m_header->addSection(tr("<i>Embedded software version</i>"), tr("<b>Embedded software version:</b> Identify the embedded software version that was running on the selected anemometer."), CustomHeader::QuestionMarkHint::QuestionMark, ClickLabel::AnemSwVersion);
