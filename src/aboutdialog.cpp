    ...
    : QDialog(parent)
{
    ...
    QLabel *introduction = new QLabel(
            tr("<h2>%1<sup>&reg;</sup> version %2 %3</h2><h6>Built on %4 at %5<br />Based on Qt %6 (%7)<br /></h6>"
               ).arg(Defs::APP_NAME)
    ...
    QLabel *infoLabel = new QLabel(
            tr("<br />%1 is an open source software application that is developed, "
               "maintained, supported by LI-COR Biosciences. It originates from ECO2S, the "
               "Eddy COvariance COmmunity Software project, which was developed as part of "
               "the IMECC-EU research project.</p>"
               "<p>We gratefully acknowledge the IMECC consortium, the ECO2S development "
               "team, the University of Tuscia (Italy) and scientists around the world who "
               "assisted with development and testing of the original version of this "
               "software."
    ...
    // Thanks
    QWidget *thanksWidget = new QWidget();
    QLabel *thanksLabel = new QLabel(tr( "<br />We would like to thank the whole "
    ...
    QTextEdit *thanksEdit = new QTextEdit();
    QString thanksText = tr(
        ...
        "<li>Digia Plc: Qt Creator IDE</li>"
        "<li>Code::Blocks IDE</li>"
        "<li>\n</li>"
        "</ul>"
    );
    thanksEdit->setText(thanksText);
    ...
    QLabel *licenseLabel = new QLabel(tr("<br />The %1 software application is Copyright &copy; 2011-2014 LI-COR Inc.\n\n"
                                         ...
                                         "Biosciences at "
                                         "<a href=\"mailto:envsupport@licor.com?subject=%1 %2&body=Please, send me a copy of the source package.\">envsupport@licor.com</a>.").arg(Defs::APP_NAME).arg(Defs::APP_VERSION_STR));
    ...
    // Changelog
    QWidget *changelogWidget = new QWidget();
    QLabel *changelogLabel = new QLabel(tr("<br />Software updates include bug fixes, usability improvements\n\n"
                                           "and feature enhancements. These are summarized in the change log below."));
    changelogLabel->setWordWrap(true);
    changelogLabel->setOpenExternalLinks(true);

    QTextEdit *changelogEdit = new QTextEdit();
    ...
    QVBoxLayout *changelogLayout = new QVBoxLayout();
    ...
    closeButton->setProperty("commonButton", true);
